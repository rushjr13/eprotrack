              ...
              <table class="table no-border" style="margin-bottom: 0px" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    ...
                    <td class="text-center" width="3%">:</td>
                    <?php
                      $datamak = $penyedia['mak'];
                      $explodemak = explode(";",$datamak);
                      $mak = implode("<br>",$explodemak);
                    ?>
                    <th><?=$mak ?></th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-center">:</td>
                    <?php
                      $datalokasi = $penyedia['lokasi'];
                      $explodelokasi = explode(";",$datalokasi);
                      $lokasi = implode("<br>",$explodelokasi);
                    ?>
                    <th><?=$lokasi ?></th>
                  </tr>
                  <tr>
                    ...
                    <td class="text-center">:</td>
                    <?php
                      $datadetaillokasi = $penyedia['detail_lokasi'];
                      $explodedetaillokasi = explode(";",$datadetaillokasi);
                      $detail_lokasi = implode("<br>",$explodedetaillokasi);
                    ?>
                    <th><?=$detail_lokasi ?></th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-center">:</td>
                    <?php
                      $datajenispengadaan = $penyedia['jenis_pengadaan'];
                      $explodejenispengadaan = explode(";",$datajenispengadaan);
                      $jenis_pengadaan = implode("<br>",$explodejenispengadaan);
                    ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">:</td>
                    <?php
                      $datappjp = $penyedia['pagu_perjenis_pengadaan'];
                      $explodeppjp = explode(";",$datappjp);
                      $pagu_perjenis_pengadaan = $explodeppjp[0];
                    ?>
                    <th>Rp. <?=number_format($pagu_perjenis_pengadaan, 0, ',', '.') ?>,-</th>
                  </tr>
                  <tr>
                    <td>Swakelola</td>
                    <td class="text-center">:</td>
