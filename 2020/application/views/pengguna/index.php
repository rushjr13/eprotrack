<div class="box box-primary">
  <div class="box-header">
    ...
    <div class="box-tools pull-right">
      <a href="<?=base_url('pengguna/tambah') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Tambah"><i class="fa fa-user-plus"></i></a>
    </div>
  </div>
</div>
      ...
      <div class="box box-<?=$warna ?>">
        <div class="box-body box-profile">
          ...
          <div class="text-center">
            <div class="btn-group">
              <a href="<?=base_url('pengguna/ubah/'.$user['username']) ?>" class="btn btn-<?=$warna ?>" data-toggle="tooltip" title="Ubah"><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-content">
      ...
      <form id="formstatusmodal" action="" method="post">
        <div class="modal-body">
          ...
          <p class="text-center" id="ket">Ubah Status Pengguna?</p>
        </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form id="formhapusmodal" action="" method="post">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-sm btn-flat btn-default pull-left" data-dismiss="modal"><i class="fa fa-times"></i> Batal</button>
          <button type="submit" class="btn btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i> Hapus</button>
        </div>
      </form>
    </div>
  </div>
...
<script type="text/javascript">
  $(document).on("click", "#tblstatuspengguna", function(){
    ...
    $("#modalStatus #tblsts").attr("class","btn btn-sm btn-flat btn-"+warna);
