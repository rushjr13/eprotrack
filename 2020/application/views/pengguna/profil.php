              ...
              <div class="col-sm-6">
                <?php if($pengguna_masuk['id_level']==1){ ?>
                  <select class="form-control select2" id="level" name="level" style="width: 100%;">
                    <option value="">-- Pilih --</option>
                    <option value="1" <?php if($pengguna_masuk['id_level']=="1"){echo "selected";} ?>>Admin</option>
                    <option value="2" <?php if($pengguna_masuk['id_level']=="2"){echo "selected";} ?>>Pengguna</option>
                  </select>
                ...
                <?php }else{ ?>
                  ...
                  <input type="hidden" name="level" id="level" value="<?=$pengguna_masuk['id_level'] ?>">
                <?php } ?>
              </div>
            </div>
            <div class="form-group">
