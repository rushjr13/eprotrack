<div class="box box-primary">
  <form class="form-horizontal" action="<?=base_url('pengguna/tambah') ?>" method="post">
		<div class="box-header with-border">
	    <h3 class="box-title"><?=$subjudul ?></h3>
	    <div class="box-tools pull-right">
		    <button type="submit" class="btn btn-box-tool" data-toggle="tooltip" title="Simpan"><i class="fa fa-save"></i></button>
		    <a href="<?=base_url('pengguna') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Kembali"><i class="fa fa-times"></i></a>
	    </div>
	  </div>
    <div class="box-body row">
    	<div class="col-sm-6 col-sm-offset-3">
	      <div class="form-group">
	        ...
	        <div class="col-sm-9">
	          <input type="text" class="form-control" id="username" name="username" placeholder="Nama Pengguna" autofocus autocomplete="off" value="<?=set_value('username') ?>">
	      ...
	      <div class="form-group">
            ...
            <?php echo form_error('password', '<small class="text-danger margin-l-5" style="font-style:italic;"><i class="fa fa-fw fa-exclamation-triangle"></i> ', '</small><br>'); ?>
	          <small class="text-muted"><i class="fa fa-fw fa-info-circle"></i> Kata Sandi default : 123456</small>
	        </div>
	      </div>
	      <div class="form-group">
	        <label for="nama_lengkap" class="col-sm-3 control-label">Nama Lengkap</label>
	        <div class="col-sm-9">
	          <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Nama Lengkap" autocomplete="off" value="<?=set_value('nama_lengkap') ?>">
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-sm-9">
	          <input type="text" class="form-control" id="email" name="email" placeholder="Email" autocomplete="off" value="<?=set_value('email') ?>">
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-sm-9">
	          <textarea class="form-control" rows="3" id="alamat" name="alamat" placeholder="Alamat lengkap ..."><?=set_value('alamat') ?></textarea>
